...
-- This table stores all interests from UI (Cafe, Activity, Pub & Bar, Sport)
CREATE TABLE interests (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    code VARCHAR(100) NOT NULL UNIQUE,
    display_name TEXT NOT NULL,
    icon TEXT,
    category VARCHAR(50) NOT NULL, -- 'cafe', 'activity', 'pub_bar', 'sport'
...
CREATE INDEX idx_interests_active ON interests(is_active) WHERE is_active = TRUE;
